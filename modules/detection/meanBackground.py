...
if __name__ == '__main__':
    ...
    ap.add_argument("-f", "--path", default='E:\\data\\3D_pre\\D8_T4', help="Path to the directory containing the video file")
    ...
    for icamid, filelist in camids.items():
        bg_file = os.path.join(backgrounds, f'background_{icamid}.jpg')
