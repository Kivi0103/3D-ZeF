...
if __name__ == '__main__':
    ...
    ap.add_argument("-f", "--path", default='E:\\data\\3D_pre\\D4_T5', help="Path to the directory containing the video file")
    ap.add_argument("--video_name", default='2021_10_15_06_49_59_ch16.avi', help="camerid and recording datetime")
