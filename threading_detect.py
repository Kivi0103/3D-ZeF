...
if __name__ == '__main__':
    ...
    ap.add_argument("--DayTank", default="D1_T2", type=str)
            ...
            if process_name in processed_list:
                ...
                if camera_id_map[camNO] == 1:
                    cmd_str = f"python modules/yolo5/detect.py " \
                        f"--weights /home/huangjinze/code/3D-ZeF/modules/Sessions/train_ZeF_top/zerbrafish_top3/weights/best.pt " \
                        f"--config_path {exp_floder} " \
                        f"--region_name {iregion} " \
                    ...
                    cmd_str = f"python modules/yolo5/detect_side.py " \
                        f"--weights /home/huangjinze/code/3D-ZeF/modules/Sessions/train_ZeF_front/zerbrafish_front7/weights/best.pt " \
                        f"--config_path {exp_floder} " \
                        f"--region_name {iregion} " \
                        f"--source {ivideo} --device {gpustr} " \
                        f"--project {process_floder} " \
...
# python modules/yolo5/detect_side.py --weights F:/3D-ZeF_Data/data/best.pt --config_path F:/3D-ZeF_Data/data/D1_T1 --region_name 4_6PPD1ppm --source F:/3D-ZeF_Data/data/D1_T1/cut_video/2021_10_11_21_49_59_ch01.avi --device 0 --project F:/3D-ZeF_Data/data/D1_T1/processed/4_6PPD1ppm --img 640