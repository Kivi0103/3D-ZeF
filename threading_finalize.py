...
if __name__ == '__main__':
    ...
    ap.add_argument("--code_path", default="F:\\zef_data\\3D-ZeF", type=str)
    ap.add_argument("--data_path", default="F:\\zef\\", type=str)
    ...
    ap.add_argument("--outer", default="finalTrack", type=str)
    args = ap.parse_args()
    ...
    if(platform.system()=='Windows'):
        ...
        outer_floder = os.path.join(f"{data_path}\\{args.DayTank}\\{args.outer}")
    ...
    for itrafile in sorted(track_files):
        ...
        outpath = track_path.replace(args.tracker, args.outer)
        ...
        if outfile in processed_list:
            ...
            cmd_str = f"python {code_path}/modules/tracking/FinalizeTracks.py " \
